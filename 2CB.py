...
class datalogger():
    ...
    def writeJsonFileError(self,text):
        ...
        with open("/home/linaro/datalogger/jsonfile/error.json", "w") as outfile:
        ...
        try:
            ...
            for row in d:
                ...
                for col in row:
                    ...
                    cell.value = col
                    j += 1
            fileExcelFlow = "/home/linaro/datalogger/excel/Totalflow.xlsx"
        ...
        try:
            ...
            for row in d:
                ...
                for col in row:
                    ...
                    cell.value = col
                    j += 1
            fileExcel = "/home/linaro/datalogger/excel/database.xlsx"
            book.save(fileExcel)
            self.writeJsonFileError("None")
            return fileExcel
        except:
...
class dataStorage(ftpFile):
    ...
    def createFolder(self,name):
        try:
            ...
            if os.path.exists("/home/linaro/datalogger/" + name) == False:
                os.mkdir("/home/linaro/datalogger/" + name)
            if os.path.exists("/home/linaro/datalogger/" + name + "/20" + real_date[6:8]) == False:  
                os.mkdir("/home/linaro/datalogger/" + name + "/20" + real_date[6:8])
            if os.path.exists("/home/linaro/datalogger/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2]) == False: 
                os.mkdir("/home/linaro/datalogger/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2])
            if os.path.exists("/home/linaro/datalogger/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]) == False: 
                os.mkdir("/home/linaro/datalogger/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5])
    ...
    def createFile(self,name,server,username,password):
        try:
            ...
            if os.path.exists("/home/linaro/datalogger/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]) == False:
                ...
                path = "/home/linaro/datalogger/"+ name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]
            else:
                path = "/home/linaro/datalogger/"+ name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]
...
class fileJson(dataStorage):
    ...
    def readJsonFileModbus(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/dataModbus.json','r')
            d = f.read()
            obj=json.loads(d)
            port = str(obj['Port'])
    ...
    def readValue(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/sensor_values.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def readFlow(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/Flow.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def writeFlow(self,tg):
        try:
            ...
            with open("/home/linaro/datalogger/jsonfile/Flow.json", "w") as outfile:
                outfile.write(json_object)
        except Exception as e:
            print("Loi: " + str(e))
    ...
    def readJsonFileExcel(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/exportExcel.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def readJsonFileExcelFlow(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/exportExcelFlow.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def readJsonSensorMode(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/sensor_mode.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def writeJsonFileExcel(self):
        try:
            ...
            with open("/home/linaro/datalogger/jsonfile/exportExcel.json", "w") as outfile:
                outfile.write(json_object)
        except:
    ...
    def writeJsonFileExcelFlow(self):
        try:
            ...
            with open("/home/linaro/datalogger/jsonfile/exportExcelFlow.json", "w") as outfile:
    ...
    def readJsonFileFtp(self):
        try:
            f = open('/home/linaro/datalogger/jsonfile/dataFtp.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def writeJsonFile(self,LL,MN):
        try:
            ...
            with open("/home/linaro/datalogger/jsonfile/sensor_values.json", "w") as outfile:
                outfile.write(json_object)
        except:
...
t1 = time.time()
while(duration<298):
    dLL = abs(float(obj1.readData(obj1.port,obj1.baud,"float","4112","4")))
    dMN = round((28.5-float(obj1.readData(obj1.port,obj1.baud,"float","62","1"))),3)
    ...
    if pre_Total is None:
        Total = list_arr1
    elif pre_Total > 50000000:
        Total = list_arr1
    else:
        total1 = (pre_Total)/100
...
obj1.addDataFlow(Date=time1,Time=real_time,dTG=Total)
duration = 0
