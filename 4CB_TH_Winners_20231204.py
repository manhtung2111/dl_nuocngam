...
class datalogger():
    ...
    def writeJsonFileError(self,text):
        try:
            ...
            with open("/home/linaro/datalogger_WNVN/jsonfile/error.json", "w") as outfile:
        ...
        try:
            ...
            for row in d:
                ...
                for col in row:
                    ...
                    cell.value = col
                    j += 1
            fileExcelFlow = "/home/linaro/datalogger_WNVN/excel/Totalflow.xlsx"
        ...
        try:
            ...
            for row in d:
                ...
                for col in row:
                    ...
                    cell.value = col
                    j += 1
            fileExcel = "/home/linaro/datalogger_WNVN/excel/database.xlsx"
            book.save(fileExcel)
            self.writeJsonFileError("None")
            return fileExcel
        except Exception as e:
...
class dataStorage(ftpFile):
    ...
    def createFolder(self,name):
        try:
            ...
            if os.path.exists("/home/linaro/datalogger_WNVN/" + name) == False:
                os.mkdir("/home/linaro/datalogger_WNVN/" + name)
            if os.path.exists("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8]) == False:  
                os.mkdir("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8])
            if os.path.exists("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2]) == False: 
                os.mkdir("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2])
            if os.path.exists("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]) == False: 
                os.mkdir("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5])
    ...
    def createFile(self,name,server,username,password,number):
        try:
            ...
            if os.path.exists("/home/linaro/datalogger_WNVN/" + name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]) == False:
                ...
                path = "/home/linaro/datalogger_WNVN/"+ name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]
            else:
                path = "/home/linaro/datalogger_WNVN/"+ name + "/20" + real_date[6:8] + "/" + real_date[0:2] + "/" + real_date[3:5]
...
class fileJson(dataStorage):
    ...
    def readJsonFileModbus(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/dataModbus.json','r')
            d = f.read()
            obj=json.loads(d)
            port = str(obj['Port'])
    ...
    def readValue(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/sensor_values.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def readFlow(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/Flow.json','r')
            d = f.read()
            obj=json.loads(d)
            tg1 = float(obj['TongGieng1'])
            tg2 = float(obj['TongGieng2'])
            if tg1 is None:
                tg1 = 13057.23
            if tg2 is None:
                tg2 = 12940.45
    ...
    def writeFlow(self,tg1,tg2):
        try:
            ...
            with open("/home/linaro/datalogger_WNVN/jsonfile/Flow.json", "w") as outfile:
                outfile.write(json_object)
        except Exception as e:
            print("Loi: " + str(e))
    ...
    def readJsonFileExcel(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/exportExcel.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def readJsonFileExcelFlow(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/exportExcelFlow.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def readJsonSensorMode(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/sensor_mode.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def writeJsonFileExcel(self):
        try:
            ...
            with open("/home/linaro/datalogger_WNVN/jsonfile/exportExcel.json", "w") as outfile:
                outfile.write(json_object)
        except Exception as e:
            print("Loi: " + str(e))
    ...
    def writeJsonFileExcelFlow(self):
        try:
            ...
            with open("/home/linaro/datalogger_WNVN/jsonfile/exportExcelFlow.json", "w") as outfile:
    ...
    def readJsonFileFtp(self):
        try:
            f = open('/home/linaro/datalogger_WNVN/jsonfile/dataFtp.json','r')
            d = f.read()
            obj=json.loads(d)
    ...
    def writeJsonFile(self,dLL1,dMN1,dLL2,dMN2):
        try:
            ...
            with open("/home/linaro/datalogger_WNVN/jsonfile/sensor_values.json", "w") as outfile:
                outfile.write(json_object)
        except Exception as e:
            print("Loi: " + str(e))
...
while duration<298:
    ...
    dMN2 = round(random.uniform(10, 11), 2)
    ...
    if pre_Total_1 is None:
        Total_1 = list_arr1[0]
    elif pre_Total_1 > 100000:
        Total_1 = list_arr1[0]
    else:
        total_1 = (pre_Total_1)/100
        Total_1 = round(total_1,2)
        list_arr1[0] = Total_1
    if pre_Total_2 is None:
        Total_2 = list_arr1[1]
    elif pre_Total_2 > 100000:
        Total_2 = list_arr1[1]
    else:
        Total_2 = (pre_Total_2)/100
    ...
    obj1.writeFlow(Total_1,Total_2)
    real_datetime = datetime.datetime.now()
    real_time = real_datetime.strftime("%X")
    real_date = real_datetime.strftime("%x")
